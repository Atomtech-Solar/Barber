-- Suporta agendamento público (cliente sem conta) e client_email

-- 1. Adicionar client_email
ALTER TABLE appointments
  ADD COLUMN IF NOT EXISTS client_email TEXT;

-- 2. RPC para criação de agendamento público (anon/walk-in)
-- Segurança: valida company ativa, professional, services; insere com client_id NULL
...
BEGIN
  ...
  -- Validar professional pertence à company e está ativo
  SELECT EXISTS(
  ...
  -- Validar services pertencem à company
