-- Patch: get_client_history sem depender de company_client_id
-- Resolve 400 Bad Request quando a coluna não existe (migration 036 não aplicada)
...
BEGIN
  ...
  -- Match por user_id ou telefone (evita company_client_id que pode não existir)
