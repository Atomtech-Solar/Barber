-- Permissões simples por página e edição de perfil de membro por empresa

ALTER TABLE public.company_members
  ADD COLUMN IF NOT EXISTS allowed_pages TEXT[] NULL;

COMMENT ON COLUMN public.company_members.allowed_pages IS
'Permissões simples por página no app. NULL = acesso total padrão.';
...
DROP FUNCTION IF EXISTS public.upsert_company_member(UUID, TEXT, TEXT, TEXT, TEXT);
