-- Alinhar páginas permitidas em RPCs com o app (payments, mural, notifications).
-- Sem isso, upsert_company_member falha com 400 quando o admin envia allowed_pages completo.
